...
export const TARIFS: Tarif[] = [
  ...
  // ============================================================
  {
    ...
    accroche: "Remplacer un cumulus électrique ou un ballon thermodynamique : prix au reel.",
    prix_min: 300,
    prix_max: 3500,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      "Type d'appareil : électrique, thermodynamique ou solaire",
    ...
    economies: [
      ...
      "Vérifier l'éligibilité MaPrimeRenov' pour le thermodynamique avant signature",
    ],
    faq: [
      { q: "Combien de temps pour la pose ?", r: "Comptez 2 a 4 heures pour un cumulus électrique standard, une demi-journee pour un thermodynamique." },
  ...
  },
  {
    ...
    accroche: "Intervention en urgence : temps de main-d'oeuvre et accès a la fuite font tout.",
    prix_min: 80,
    prix_max: 450,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      "Heure d'intervention : jour, nuit, week-end ou férié",
    ...
    variantes: [
      ...
      { nom: "Intervention nuit/dimanche/férié", prix_min: 200, prix_max: 600, note: "Majoration légale jusqu'a 100 pourcents" },
    ],
    economies: [
      "Avant d'appeler : couper l'arrivee d'eau generale et photographier la fuite",
      "Refuser tout intervention sans devis écrit signe (sauf urgence avec degats en cours)",
      "Comparer les frais de deplacement, parfois plus chers que la réparation",
    ],
    faq: [
      { q: "Le plombier peut-il refuser un devis ?", r: "Non, depuis 2017 un devis écrit est obligatoire des que la prestation depasse 100 euros TTC." },
      ...
      { q: "Combien coute la recherche de fuite ?", r: "200 a 600 euros selon la méthode (hygrometre, gaz tracer, cameras thermiques)." },
    ],
  ...
  },
  {
    ...
    accroche: "Demolition baignoire, étanchéité, evacuation, faience : un poste a 3000 euros minimum.",
    prix_min: 1500,
    prix_max: 6500,
    unite: "intervention",
    inclus: "tout-compris",
    ...
    economies: [
      "Conserver l'arrivee et l'evacuation d'eau existantes évite 500 a 1000 euros",
      "Choisir un meuble vasque standard (Leroy, Castorama) plutot que sur-mesure",
      "Eligible TVA réduite 10 pourcents sur logement plus de 2 ans",
    ],
    faq: [
      { q: "Combien de jours de chantier ?", r: "5 a 8 jours ouvres, sechage de l'étanchéité et du carrelage compris." },
  ...
  },
  {
    ...
    accroche: "75 pourcents d'énergie en moins qu'un cumulus électrique : retour sur investissement 5 a 7 ans.",
    prix_min: 1800,
    prix_max: 4500,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Type : sur air ambiant, sur air extérieur ou split",
    ...
    variantes: [
      ...
      { nom: "Sur air extérieur 200L (rendement superieur)", prix_min: 2500, prix_max: 3800 },
      { nom: "Split 250L (avec unite extérieure)", prix_min: 3500, prix_max: 4500, note: "Idem clim, necessite Cat 1 fluides" },
    ],
    economies: [
  ...
  // ============================================================
  {
    ...
    metier: "electricien",
    nom: "Mise aux normes tableau électrique (NF C 15-100)",
    ...
    inclus: "tout-compris",
    facteurs: [
      "État du tableau existant (année, technologie)",
    ...
    economies: [
      "Profiter d'autres travaux électriques pour mutualiser le tableau",
      "Conserver les disjoncteurs differentiels récents si moins de 10 ans",
      "TVA 10 pourcents sur logement existant",
    ],
    faq: [
      { q: "Faut-il forcement un Consuel après ?", r: "Oui en cas de remplacement complet ou si le tableau touche au point de livraison Enedis." },
  ...
  {
    slug: "installation-prise-électrique",
    metier: "electricien",
    nom: "Installation prise électrique supplementaire",
    ...
    facteurs: [
      ...
      "Refection peinture/placo après encastrement",
    ],
    variantes: [
    ...
    faq: [
      ...
      { q: "Une prise USB intégrée, c'est combien en plus ?", r: "Compter 30 a 60 euros de fourniture en plus pour un module USB-C double." },
    ...
    source: { label: "Capeb guide tarifs électricité", url: "https://www.capeb.fr/" },
  },
  {
    slug: "pose-luminaire",
    metier: "electricien",
    ...
    inclus: "pose-seule",
    facteurs: [
      "Hauteur de pose (accès avec echafaudage si plus de 3 m)",
      "Type de luminaire (lustre lourd, applique simple, suspension)",
      "Pose sur point existant ou création d'un point",
      "Domotique : variateur, va-et-vient, telecommande",
    ],
    variantes: [
      { nom: "Pose simple sur DCL existant", prix_min: 40, prix_max: 90 },
      { nom: "Pose avec création d'un point lumineux", prix_min: 120, prix_max: 250 },
    ...
    faq: [
      { q: "Mon plafond a-t-il un point DCL ?", r: "Tout logement neuf depuis 2003 oui (Dispositif de Connexion pour Luminaire). Avant : a vérifier." },
      { q: "Pose multipoint, quel rabais ?", r: "Comptez 20 a 30 pourcents de remise au-dela de 3 luminaires sur le meme rendez-vous." },
      { q: "Eclairage extérieur avec detecteur ?", r: "Comptez 80 a 200 euros supplementaires pour la fourniture du detecteur et son raccordement." },
    ],
    source: { label: "Capeb statistiques charges électricien", url: "https://www.capeb.fr/" },
  },
  {
    slug: "borne-recharge-vehicule-électrique",
    metier: "electricien",
    nom: "Installation borne de recharge vehicule électrique",
    ...
    facteurs: [
      ...
      "Distance entre tableau électrique et borne",
    ...
    economies: [
      "Credit d'impot transition énergétique : 75 pourcents jusqu'a 500 euros par borne",
    ...
    faq: [
      { q: "Faut-il un électricien IRVE ?", r: "Obligatoire pour le credit d'impot et au-dela de 3,7 kW. Trois niveaux IRVE : P1, P2, P3." },
  ...
  // ============================================================
  {
    ...
    metier: "couvreur",
    nom: "Refection toiture complète",
    ...
    facteurs: [
      ...
      "État de la charpente (a renforcer ou non)",
      "Pente du toit et accès (echafaudage)",
    ...
    economies: [
      "Mutualiser avec une isolation par l'extérieur (sarking) éligible MaPrimeRenov'",
  ...
  },
  {
    ...
    facteurs: [
      ...
      "État de la mousse (epaisse, lichens incrustes)",
      "Méthode : pulverisation, brossage, haute pression",
    ...
    economies: [
      ...
      "Mefiance face aux demarchages telephoniques (pratiques abusives fréquentes)",
  ...
  },
  {
    ...
    facteurs: [
      ...
      "Type et disponibilite du modèle d'origine",
    ...
    economies: [
      "Identifier soi-meme les tuiles cassees après tempete (jumelles depuis le sol)",
      "Stocker des tuiles d'avance lors de l'achat initial",
      "Faire appel a l'assurance habitation si tempete déclarée (garantie evenements climatiques)",
    ],
    faq: [
      { q: "Mon assurance peut-elle prendre en charge ?", r: "Oui si la casse vient d'un evenement climatique (tempete, grele) déclaré. Pas pour l'usure normale." },
      { q: "Combien de temps avant intervention ?", r: "Comptez 1 a 3 semaines hors urgence, plus court si fuite active." },
      { q: "Tuile modèle plus fabrique : que faire ?", r: "Le couvreur peut chercher en depot ou remettre des tuiles equivalentes (couleur proche)." },
    ],
    source: { label: "FFB Fédération Francaise du Batiment couvreurs", url: "https://www.ffbatiment.fr/" },
  },
  {
    slug: "isolation-combles-perdus",
    metier: "couvreur",
    nom: "Isolation combles perdus par soufflage",
    accroche: "Le geste le plus rentable : 25 pourcents d'economie de chauffage, éligible MaPrimeRenov'.",
    prix_min: 20,
    prix_max: 50,
    unite: "m2",
    inclus: "tout-compris",
  ...
  // ============================================================
  {
    ...
    accroche: "Du standard 1 vantail 80x100 au triple vitrage : la fourchette s'étalé du simple au quadruple.",
    prix_min: 350,
    prix_max: 1500,
    unite: "u",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Technique de pose : depose totale ou rénovation",
    ...
    economies: [
      ...
      "Pose en rénovation (sur dormant existant) economise 20 pourcents",
    ],
    faq: [
  ...
  },
  {
    ...
    economies: [
      "Vérifier remise de l'assurance habitation (jusqu'a 10 pourcents) si A2P",
      "Choisir une marque française pour SAV plus rapide",
      "TVA 10 pourcents sur logement de plus de 2 ans",
    ],
    faq: [
      ...
      { q: "Combien de temps de pose ?", r: "Une journee pour une porte d'entrée standard, 1,5 jour pour une porte alu sur mesure." },
    ],
  ...
  },
  {
    ...
    accroche: "Droit, quart-tournant, helicoidal : du modèle standard a l'escalier d'architecte.",
    prix_min: 2500,
    prix_max: 12000,
    unite: "u",
    inclus: "tout-compris",
    ...
    faq: [
      { q: "Quelle pente réglementaire ?", r: "Hauteur de marché 17 a 21 cm, giron 25 a 32 cm. Au-dela : escalier non conforme." },
  ...
  },
  {
    ...
    accroche: "Du dressing simple a la solution intégrée avec éclairage : le metre lineaire fait foi.",
    prix_min: 800,
    prix_max: 4500,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Equipements intérieurs (LEDs, tiroirs, panieres)",
    ],
    variantes: [
      ...
      { nom: "Solution intégrée 4 m + éclairage LED", prix_min: 3000, prix_max: 4500 },
    ],
    economies: [
      "Acheter les aménagements intérieurs sur Ikea/Lapeyre et faire poser le coffre",
      "Eviter les portes laquees brillantes (entretien et SAV difficile)",
      "Profiter d'autres travaux pour negocier (peinture, électricité)",
    ],
    faq: [
      { q: "Combien de temps de fabrication ?", r: "3 a 6 semaines après metrage definitif, fabrication en atelier." },
      { q: "Sur murs non droits, comment faire ?", r: "Pose de joues ajustees ou cale d'habillage. Le metrage initial doit relever les défauts." },
      { q: "Garantie SAV ?", r: "Décennale obligatoire + garantie biennale sur quincaillerie (charnieres, rails)." },
    ],
    source: { label: "Fédération française du batiment menuisiers", url: "https://www.ffbatiment.fr/" },
  },
  ...
  // ============================================================
  {
    ...
    metier: "isolation",
    nom: "Isolation combles perdus par soufflage",
    accroche: "Le geste isolation le plus rentable : ROI 5 a 7 ans, éligible toutes les aides.",
    prix_min: 20,
    prix_max: 45,
    unite: "m2",
    inclus: "tout-compris",
    facteurs: [
      ...
      "État existant (a vider ou a recouvrir)",
    ],
    variantes: [
    ...
    faq: [
      { q: "Mes combles sont accessibles, autre méthode ?", r: "Si combles habitables ou amenageables : isolation des rampants par l'intérieur (panneaux)." },
  ...
  },
  {
    ...
    faq: [
      { q: "Faut-il une déclaration prealable ?", r: "Oui obligatoire (modification d'aspect). Permis de construire si plus de 20 m2 ajoutes." },
  ...
  },
  {
    ...
    variantes: [
      ...
      { nom: "Sarking par extérieur (depose toiture)", prix_min: 150, prix_max: 250 },
    ],
    economies: [
      "Mutualiser avec refection toiture (sarking)",
      "MaPrimeRenov' jusqu'a 25 euros/m2",
      "Vérifier ventilation existante avant pose pare-vapeur",
    ],
    faq: [
      { q: "Quelle épaisseur minimale ?", r: "200 mm minimum pour atteindre R = 6, 240 mm pour R = 7 (cible BBC)." },
      { q: "Pare-vapeur obligatoire ?", r: "Oui, cote chaud (intérieur). Sa pose conditionne la garantie décennale." },
      { q: "Hauteur sous plafond perdue ?", r: "Comptez 25 a 30 cm de hauteur en moins (isolant + placo)." },
    ],
    source: { label: "ADEME guide isolation toiture intérieure", url: "https://librairie.ademe.fr/" },
  },
  {
    ...
    facteurs: [
      ...
      "Reprise réseau électrique au plafond",
    ],
    variantes: [
    ...
    economies: [
      ...
      "Combinable avec isolation murs sous-sol pour éligibilité plus large",
    ],
    faq: [
      { q: "R minimum pour aides ?", r: "R = 3 m2.K/W minimum pour MaPrimeRenov' (épaisseur 100 a 120 mm de PSE)." },
  ...
  // ============================================================
  {
    ...
    accroche: "Plus éligible MaPrimeRenov' depuis 2023 : ROI sur economie consommation.",
    prix_min: 3500,
    prix_max: 7500,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Marque et gamme (entrée, milieu, haut)",
      "Reprise tuyauterie et radiateurs",
      "Sortie ventouse ou cheminee a tuber",
    ],
    variantes: [
      { nom: "Chaudiere 24 kW entrée de gamme", prix_min: 3500, prix_max: 4500 },
  ...
  },
  {
    ...
    facteurs: [
      ...
      "Garanties incluses (P1 visite, P2 réparations)",
    ...
    variantes: [
      ...
      { nom: "Contrat P1+P2 (réparations incluses)", prix_min: 200, prix_max: 350 },
    ],
    economies: [
    ...
    faq: [
      { q: "L'entretien est-il obligatoire ?", r: "Oui pour gaz, fioul, bois (décret 2009-649). Locataire a la charge." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Plinthe ou panneau ?", r: "Plinthe : adapte aux pièces longues. Panneau classique : plus repandu, moins cher." },
      { q: "Combien de radiateurs pour 100 m2 ?", r: "5 a 7 radiateurs selon isolation. 100 W/m2 en moyenne pour pavillon des années 80." },
    ],
  ...
  // ============================================================
  {
    ...
    accroche: "BA13 standard, hydro pour pièces humides, phonique : le m2 varie du simple au double.",
    prix_min: 40,
    prix_max: 110,
    unite: "m2",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Isolation intérieure (laine minerale)",
    ...
    source: { label: "Fédération Francaise du Batiment plaquistes", url: "https://www.ffbatiment.fr/" },
  },
  {
    slug: "faux-plafond-suspendu",
    metier: "plaquiste",
    nom: "Faux plafond suspendu",
    accroche: "Cache-canalisations, isolation phonique, éclairage encastre : un poste a 50-90 euros au m2.",
    prix_min: 40,
    prix_max: 100,
    unite: "m2",
    inclus: "tout-compris",
    ...
    faq: [
      ...
      { q: "Spots LED : combien par m2 ?", r: "1 spot pour 1,5 a 2 m2 en éclairage general. 1 pour 1 m2 en cuisine/salle de bain." },
    ],
  ...
  },
  {
    ...
    metier: "plaquiste",
    nom: "Doublage isolation intérieure (ITI)",
    accroche: "Solution la plus simple en rénovation : pose contre mur, plaque + isolant intermediaire.",
    prix_min: 45,
    prix_max: 110,
    unite: "m2",
    inclus: "tout-compris",
    ...
    economies: [
      ...
      "CEE : 5 a 10 euros/m2",
      "Vérifier presence de moisissures avant doublage (sinon traitement prealable)",
    ],
    faq: [
      { q: "ITE ou ITI : que privilegier ?", r: "ITE : meilleur thermiquement, plus cher. ITI : plus simple, perte de surface intérieure." },
  ...
  },
  {
    ...
    metier: "plaquiste",
    nom: "Isolation acoustique d'une pièce",
  ...
  // ============================================================
  {
    ...
    facteurs: [
      ...
      "État du support (chape ou ragreage prealable)",
    ...
    variantes: [
      ...
      { nom: "Carrelage XXL 80x80 ou 120x120", prix_min: 100, prix_max: 180, note: "Pose plus délicate, planeite exigee" },
    ],
    economies: [
      "Acheter le carrelage en gros chez Bricoman, Brico Depot",
      "Choisir formats standards (30x60, 60x60) pour éviter les surcouts pose",
    ...
    faq: [
      ...
      { q: "Carrelage extérieur : quelle norme ?", r: "Classement R10 minimum (antiderapant), gel A1+ pour climat continental." },
  ...
  },
  {
    ...
    facteurs: [
      ...
      "Surface a couvrir et nombre de pièces a couper",
    ...
    economies: [
      ...
      "Faience entrée de gamme : aspect identique au superieur sur grandes surfaces",
    ],
    faq: [
    ...
    source: { label: "Fédération Francaise du Batiment carreleurs", url: "https://www.ffbatiment.fr/" },
  },
  {
    ...
    facteurs: [
      ...
      "État du support (planeite tres exigeante)",
    ...
    economies: [
      "Vérifier la planeite du support avant achat (ragreage souvent obligatoire)",
    ...
    faq: [
      ...
      { q: "Joint de quelle épaisseur ?", r: "2 mm minimum (norme NF DTU 52.2). Le rectifie permet jusqu'a 1 mm." },
  ...
  },
  {
    ...
    facteurs: [
      ...
      "État du support (chape, ancien carrelage, parquet)",
      "Surface a traiter",
    ...
    economies: [
      ...
      "Eviter ragreage si difference de niveau plus de 30 mm (prevoir chape complète)",
    ],
    faq: [
      { q: "Quelle épaisseur maximale possible ?", r: "30 mm pour le fibre, au-dela : chape liquide ou ciment classique." },
      { q: "Sechage avant pose carrelage ?", r: "24 h a 48 h selon épaisseur et temperature ambiante." },
      { q: "Sur parquet existant possible ?", r: "Oui avec primaire d'accrochage spécifique et fibres. Mais souvent depose préférable." },
    ],
  ...
  // ============================================================
  {
    ...
    metier: "peintre",
    nom: "Peinture murs et plafonds pièce",
    accroche: "Mise en peinture totale d'une pièce : 25 a 50 euros au m2 fini.",
    prix_min: 25,
    prix_max: 60,
    unite: "m2",
    inclus: "tout-compris",
    facteurs: [
      "État des murs (sain, fissure, moisi)",
      "Nombre de couches (1 ou 2)",
      "Qualite de la peinture (entrée, mat, satin, lessivable)",
    ...
    economies: [
      "Demander un devis detaillant les m2 de plafond et de mur (éviter les forfaits flous)",
  ...
  },
  {
    ...
    metier: "peintre",
    nom: "Peinture facade extérieure",
    ...
    inclus: "tout-compris",
    facteurs: [
      "État de la facade (saine, fissuree, moussue)",
    ...
    economies: [
      "Mutualiser avec demoussage (déjà prevu echafaudage)",
      "Faire en automne (artisans plus disponibles)",
      "Comparer 3 devis sur prix au m2 et certification CEKAL",
    ],
    faq: [
      { q: "Faut-il déclarer en mairie ?", r: "Oui si modification de couleur (déclaration prealable de travaux)." },
      { q: "Combien de temps de chantier ?", r: "5 a 10 jours pour 200 m2 facade selon meteo et état." },
      { q: "Garantie sur la peinture ?", r: "Décennale obligatoire. Tenue siloxane premium 20 ans en condition normale." },
    ],
    source: { label: "Fédération Francaise du Batiment peintres", url: "https://www.ffbatiment.fr/" },
  },
  {
    slug: "peinture-decorative",
    metier: "peintre",
    nom: "Peinture decorative et finitions",
    accroche: "Patine, beton cire, tadelakt, stuc : effet matière et finition unique.",
    prix_min: 40,
    prix_max: 250,
    unite: "m2",
    inclus: "tout-compris",
    ...
    economies: [
      ...
      "Vérifier portfolio artisan (decoratif tres different du peintre standard)",
    ],
    faq: [
      ...
      { q: "Garantie sur ces finitions ?", r: "Garantie décennale, mais entretien et patine dans le temps a anticiper (verre cire annuel)." },
    ],
    source: { label: "Cnaib métiers d'art peinture", url: "https://www.institut-metiersdart.org/" },
  },
  {
    slug: "ravalement-facade",
    metier: "peintre",
    nom: "Ravalement facade complet",
    accroche: "Nettoyage + réparation + enduit + peinture : obligatoire tous les 10 ans dans certaines communes.",
    prix_min: 40,
    prix_max: 110,
    unite: "m2",
    inclus: "tout-compris",
    facteurs: [
      "État initial (fissures, mousse, decollement)",
      "Type de support (enduit, brique, pierre)",
      "Méthode de nettoyage (haute pression, sablage, gommage)",
    ...
    faq: [
      { q: "Le ravalement est-il obligatoire ?", r: "Tous les 10 ans dans 130 communes (loi 1903). Vérifier en mairie." },
      { q: "Peut-on isoler en meme temps ?", r: "Oui, isolation thermique par l'extérieur (ITE) couplee au ravalement = meilleur ROI." },
  ...
  // ============================================================
  {
    ...
    metier: "serrurier",
    nom: "Dépannage serrure (ouverture porte)",
    accroche: "Tarif légal encadre : se mefier des arnaques, exiger devis avant intervention.",
    prix_min: 90,
    prix_max: 350,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Heure : jour, nuit (22h-6h), week-end ou férié",
    ...
    variantes: [
      ...
      { nom: "Intervention nuit/dimanche/férié", prix_min: 220, prix_max: 500, note: "Majoration légale jusqu'a 100 pourcents" },
    ],
    economies: [
      "Exiger devis écrit avant intervention (obligation légale plus de 100 euros)",
      "Mefiance sur les flyers et publicites trompeuses (surfacturation)",
      "Vérifier numero SIRET sur sirene.gouv.fr avant rendez-vous",
    ],
    faq: [
  ...
  },
  {
    ...
    accroche: "Après effraction, perte de cles ou achat : 150 a 400 euros pour un cylindre certifié A2P.",
    prix_min: 150,
    prix_max: 500,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Nombre de cles",
      "Cylindre simple ou double entrée",
    ...
    faq: [
      ...
      { q: "Cylindre brevete vs standard : difference ?", r: "Brevete = cles non reproductibles sans carte de propriété. Standard : reproductibles partout." },
      { q: "Faut-il changer après deces du propriétaire ?", r: "Bonne pratique pour les heritiers, surtout si cles ont circule (artisans, employes de maison)." },
    ],
  ...
  },
  {
    ...
    facteurs: [
      "Niveau de certification A2P (BP1, BP2, BP3)",
      "Type : porte bouclier, blindage installe, blindee complète",
      "Nombre de points de fermeture (3, 5 ou 7)",
    ...
    economies: [
      "Vérifier remise assurance habitation (jusqu'a 15 pourcents) avec A2P",
      "Bouclier seul (porte existante conservee) : moitie du prix",
      "Choisir marque française (Picard, Fichet) pour SAV reactif",
    ],
    faq: [
      ...
      { q: "Combien de temps pour la pose ?", r: "Une journee complète pour une porte blindee complète avec batterie." },
      { q: "Garantie incluse ?", r: "Décennale obligatoire + garantie 5 ans constructeur sur la mecanique." },
    ],
  ...
  },
  {
    ...
    economies: [
      ...
      "Vérifier conformité ECB.S avant achat",
  ...
  // ============================================================
  {
    ...
    accroche: "Cloison ou mur porteur : 80 a 150 euros au m2 selon épaisseur et hauteur.",
    prix_min: 80,
    prix_max: 180,
    unite: "m2",
    inclus: "tout-compris",
    facteurs: [
      ...
      "Enduit de finition (cote intérieur, extérieur)",
    ],
    variantes: [
    ...
    faq: [
      ...
      { q: "Faut-il un permis ?", r: "Pour mur de cloture plus de 2 m ou mur extérieur : déclaration prealable obligatoire." },
      { q: "Parpaing ou brique ?", r: "Parpaing : plus rapide, moins cher. Brique monomur : plus isolant, plus cher." },
    ],
    source: { label: "FFB Fédération maconnerie", url: "https://www.ffbatiment.fr/" },
  },
  {
    slug: "dalle-beton",
    metier: "macon",
    nom: "Dalle beton au m2",
    accroche: "Garage, terrasse, fondation legere : 40 a 90 euros au m2 selon épaisseur et armature.",
    prix_min: 40,
    prix_max: 110,
    unite: "m2",
    inclus: "tout-compris",
    ...
    faq: [
      { q: "Combien de temps de sechage ?", r: "Marché après 24 h, pose carrelage après 21 jours, charge complète après 28 jours." },
      { q: "Renforcement obligatoire ?", r: "Treillis a 5x5 cm minimum sous dalle plus de 6 m2. Double treillis pour grandes portees." },
      { q: "Puis-je faire moi-meme ?", r: "Oui pour terrasses jusqu'a 20 m2 avec équipement. Au-dela : maconnerie professionnelle pour garantie décennale." },
    ],
  ...
  },
  {
    ...
    economies: [
      "Eviter beton imprime fantaisie : a refaire 2 fois pour éviter usure",
      "Privilegier dalle pleine plutot que plots si terrain stable",
      "Couler en saison seche, éviter automne pluvieux",
    ],
    faq: [
      { q: "Faut-il un permis pour terrasse ?", r: "Plus de 5 m2 (40 m2 si dans zone constructible et hauteur plus de 60 cm) : déclaration prealable." },
      { q: "Drainage obligatoire ?", r: "Pente de 1 a 2 pourcents minimum vers extérieur ou caniveau." },
      { q: "Carrelage extérieur sur beton frais ?", r: "Attendre 28 jours sechage complet, primaire d'accrochage obligatoire." },
    ],
    source: { label: "ANAH terrasse extérieure normes", url: "https://www.anah.fr/" },
  },
  {
    slug: "enduit-facade",
    metier: "macon",
    ...
    inclus: "tout-compris",
    facteurs: [
      "État initial de la facade (sain, fissure)",
    ...
    economies: [
      "Mutualiser avec ravalement (echafaudage déjà en place)",
    ...
    faq: [
      ...
      { q: "Enduit vs peinture facade ?", r: "Enduit : couche epaisse 8 a 15 mm, masque défauts. Peinture : couche fine, sur enduit existant uniquement." },
      { q: "Garantie sur l'enduit ?", r: "Décennale obligatoire (loi Spinetta), tenue couleur 15 a 20 ans selon expose." },
    ],
  ...
  // ============================================================
  {
    ...
    economies: [
      ...
      "Demander artisan déclaré (Cesu, organisme agree)",
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Quand planter ?", r: "Octobre a mars (hors gel) pour plants en racines nues. Toute l'année pour plants en pot." },
  ...
  // ============================================================
  {
    ...
    accroche: "Une pièce a climatiser : 1500 a 3500 euros tout compris pour 2,5 a 5 kW.",
    prix_min: 1500,
    prix_max: 4000,
    unite: "intervention",
    inclus: "tout-compris",
  ...
  },
  {
    ...
    accroche: "2 a 5 unites intérieures sur une seule unite extérieure : economie d'echelle a partir de 3 pièces.",
    prix_min: 2500,
    prix_max: 9500,
    unite: "intervention",
    inclus: "tout-compris",
    facteurs: [
      "Nombre de splits intérieurs (2 a 5)",
      "Puissance totale et longueur des liaisons cuivre",
      "Type d'unites intérieures (mural, gainable, cassette)",
    ...
    economies: [
      ...
      "Choisir taille unite extérieure adaptee (éviter sur-dimensionnement 30 pourcents)",
      "Mutualiser avec autres travaux (électricité, percement)",
    ],
    faq: [
      { q: "Multi-split ou plusieurs mono-splits ?", r: "Multi-split : 1 seule unite extérieure, plus esthetique. Mono : pannes ne propagent pas." },
      { q: "Tous les splits doivent-ils tourner en meme temps ?", r: "Oui, ou bien chaque pièce independamment selon modèles. Mode chaud/froid simultane impossible (sauf VRV)." },
      { q: "Règlement de copropriete ?", r: "Demander accord prealable AG pour pose unite extérieure visible (facade, balcon, toiture)." },
    ],
    source: { label: "Cmiqs réglementation climatisation", url: "https://www.cmiqs.com/" },
  },
  {
    slug: "entretien-climatisation-annuel",
    metier: "climaticien",
    nom: "Entretien annuel climatisation",
    accroche: "Obligatoire pour clims plus de 4 kW : contrôle fluide, nettoyage, attestation.",
    prix_min: 100,
    prix_max: 250,
    unite: "annee",
    inclus: "tout-compris",
    ...
    variantes: [
      ...
      { nom: "Contrat annuel + réparations P2", prix_min: 220, prix_max: 350 },
    ],
    economies: [
    ...
    faq: [
      { q: "L'entretien est-il vraiment obligatoire ?", r: "Oui pour clims plus de 4 kW (décret 2020-912). Tous les 2 ans." },
  ...
  },
  {
    ...
    variantes: [
      { nom: "3,5 kW reversible entrée de gamme", prix_min: 1800, prix_max: 2500 },
    ...
    economies: [
      ...
      "Vérifier garantie compresseur 10 ans (haut de gamme uniquement)",
    ],
    faq: [
  ...
  // ============================================================
  {
    ...
    accroche: "Cuisine en kit poste, montee, électroménager : 3500 a 10 000 euros.",
    prix_min: 3500,
    prix_max: 12000,
    unite: "intervention",
    inclus: "tout-compris",
    ...
    economies: [
      "Acheter électroménager en gros chez Boulanger ou Darty",
      "Comparer 3 cuisinistes (devis 30 pourcents d'écart possibles)",
      "Eviter laque brillante (entretien et SAV)",
    ],
    faq: [
      { q: "Cuisine montee ou en kit ?", r: "Kit IKEA : economie 30 pourcents mais 2 jours de montage. Montee : prix plus eleve mais délai 2 a 4 semaines." },
      { q: "Combien de temps de chantier ?", r: "Demolition + plomberie/électricité : 3-5 jours. Pose cuisine : 2-3 jours. Total 1 a 2 semaines." },
      { q: "Garantie sur la cuisine ?", r: "Décennale obligatoire sur l'installation. Constructeur : 2 ans (électroménager) a 10 ans (caissons)." },
    ],
    source: { label: "Fédération des cuisinistes (FFC)", url: "https://www.fcc-france.fr/" },
  },
  {
    slug: "cuisine-sur-mesure",
    metier: "cuisiniste",
    nom: "Cuisine sur mesure haut de gamme",
    accroche: "Caissons 100 pourcents sur mesure, materiaux nobles, éclairage intégré : 8000 a 30 000 euros.",
    prix_min: 8000,
    prix_max: 30000,
    unite: "intervention",
    inclus: "tout-compris",
    ...
    economies: [
      "Faire dessiner par cuisiniste mais exécuter par menuisier local (50 pourcents moins cher)",
      "Privilegier 1 ou 2 zones premium plutot que tout en haut de gamme",
      "Mutualiser avec changement de carrelage/sol (artisan déjà sur place)",
    ],
    faq: [
      { q: "Combien de temps de fabrication ?", r: "8 a 12 semaines pour sur-mesure complet, parfois 16 semaines en haute saison." },
      { q: "Visite metreuse obligatoire ?", r: "Oui, devis sans visite chiffre approximatif. Metrage definitif après signature." },
      { q: "Acompte au cuisiniste ?", r: "30 pourcents a la commande, 30 pourcents a la fabrication, 40 pourcents a la pose." },
    ],
    source: { label: "FCC Fédération française des cuisinistes", url: "https://www.fcc-france.fr/" },
  },
  {
    slug: "ilot-central",
    metier: "cuisiniste",
    ...
    faq: [
      ...
      { q: "Hotte ilot vs hotte murale ?", r: "Hotte ilot 30 pourcents plus chere mais plus efficace pour grandes pièces ouvertes." },
    ],
  ...
  },
  {
    ...
    economies: [
      "Comparer 3 marbreries (devis a 30 pourcents d'écart possibles)",
      "Eviter les couleurs rares ou en rupture (délai et surcout)",
    ...
    faq: [
      ...
      { q: "Combien de temps de pose ?", r: "Une journee de pose, après 4 a 6 semaines de fabrication sur mesure en atelier." },
    ],
    source: { label: "Fédération française marbrerie (FFM)", url: "https://www.ffmatcb.fr/" },
  },
  ...
  // ============================================================
  {
    ...
    source: { label: "UFFEP fédération parqueteurs", url: "https://www.uffep.fr/" },
  },
  {
    ...
    faq: [
      ...
      { q: "Quelle épaisseur minimum ?", r: "20 mm pour rainure-languette, 23 mm pour cloue. En neuf : prevoir 22 mm minimum." },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Vitrification ou huile ?", r: "Vitrification : surface lisse, durable 8 a 15 ans, retouche complète necessaire. Huile : retouche zone par zone." },
      { q: "Combien de temps avant utilisation ?", r: "24 h après dernière couche pour pieton, 3 jours pour mobilier, 7 jours pour tapis." },
    ],
    source: { label: "UFFEP rénovation parquets", url: "https://www.uffep.fr/" },
  },
  {
    ...
    economies: [
      ...
      "Eviter le sur-mesure de longueur de lamelles (préférer formats standards)",
      "Limiter motif central a une seule pièce (salon)",
    ],
    faq: [
