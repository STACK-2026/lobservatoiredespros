...
export const GUIDES_METIERS: GuideMetier[] = [
    ...
    criteres: [
      {
        ...
        description: "Pour beneficier de MaPrimeRenov' et CEE sur un chauffe-eau thermodynamique, une PAC ou un solaire thermique, l'artisan doit etre RGE spécialisé. Verifiable en direct sur france-renov.gouv.fr/registre.",
        niveau: "critique",
      },
      {
        titre: "Assurance décennale plomberie active",
        description: "Obligatoire (loi Spinetta 1978). Demandez l'attestation nominative datee de moins de 12 mois. Verifiez la mention 'plomberie sanitaire et chauffage' dans les activités couvertes.",
        niveau: "critique",
      },
      {
        titre: "Habilitation gaz PG ou PGN",
        description: "Si vous installez ou renovez une chaudiere gaz, le plombier doit avoir un certificat Professionnel Gaz (PG) ou Professionnel Gaz Naturel (PGN). Sans ca : aucune mise en service légale possible.",
        niveau: "critique",
      },
      {
        titre: "Specialite affichee : dépannage, sanitaire ou chauffage",
        description: "Un dépanneur urgences a un cout horaire eleve mais peu d'expertise rénovation. Un spécialiste chauffage maitrise les bilans thermiques. Un spécialiste sanitaire concoit les salles de bain. Choisissez selon votre projet.",
        niveau: "elevee",
      },
      {
        titre: "Anciennete au registre Sirene",
        description: "Une entreprise active depuis plus de 5 ans a survecu aux moments creux et a forme ses ouvriers. Verifiez sur sirene.gouv.fr ou via notre outil /outils/vérifier-siret/.",
        niveau: "elevee",
      },
      {
        titre: "Photos de réalisations et avis clients vérifiés",
        description: "Au-dela de Google, demandez 2 ou 3 références chantiers de moins de 12 mois. Un plombier serieux a toujours quelques clients pretes a temoigner.",
        niveau: "utile",
      },
    ],
    drapeaux_rouges: [
      "Demarchage telephonique pour 'mise aux normes obligatoire' ou 'contrôle gratuit' , 90 % des cas sont des arnaques.",
      "Devis verbal pour une intervention de plus de 150 euros TTC , la loi (article L.111-1 Code conso) impose un devis écrit.",
      "Acompte demande superieur a 30 pourcents avant debut des travaux , illégal pour les artisans BTP.",
      "Refus de fournir l'attestation décennale ou prix d'un cumulus suspect pour un chauffe-eau thermodynamique RGE-aide (souvent : faux RGE).",
      "Tarifs nuit/dimanche/férié sans majoration claire affichee, ou frais de deplacement non chiffres au telephone.",
      "TVA 5,5 pourcents proposée sans certification RGE active , le taux applicable sera 20 pourcents et le devis est faux.",
    ],
    questions_devis: [
      {
        q: "Quelle est la marque exacte du chauffe-eau ou de la chaudiere proposée, et son COP/ETAS ?",
        r: "Un plombier serieux écrit la marque, le modèle, et le COP (pour PAC) ou ETAS (rendement saisonnier). Refusez 'chauffe-eau électrique 200L generique' sans référence.",
      },
      {
        q: "Quelle est la garantie sur la pose et sur les pièces ?",
        r: "Décennale obligatoire sur l'installation (10 ans). Garantie constructeur sur les pièces (2 a 10 ans selon équipement). Demandez les deux par écrit.",
      },
      {
      ...
      {
        q: "Quel est le délai d'intervention après la commande, et quelles penalites en cas de retard ?",
        r: "Un délai s'engage par écrit. Penalites de retard : standard 1/3000 par jour de retard sur le total. Si le plombier refuse, signal d'alerte.",
      },
      {
        q: "Avez-vous déjà installe ce modèle exact ? Pouvez-vous me donner 2 références locales ?",
        r: "Une question simple qui filtre les amateurs. Un spécialiste a forcement déjà pose 10+ chauffe-eau de la marque qu'il proposé.",
      },
    ],
    cas_concret: {
      titre: "Anatomie d'un devis honnete : pose chauffe-eau thermodynamique 250L",
      texte: "Sur le devis publié sur notre fiche pro Auxerre 89000, on lit : marque Atlantic Calypso 250L thermodynamique sur air ambiant, COP 3,15 a 7 degC. Pose : 850 euros HT (depose ancien cumulus + pose neuf + raccordements + mise en service). Fourniture : 2 200 euros HT (negociee 5 pourcents en dessous tarif fabricant). Sortie ventouse : 220 euros. Total : 3 270 euros HT, soit 3 597 euros TTC (TVA 10 pourcents rénovation logement plus de 2 ans). MaPrimeRenov' menages modestes : 1 200 euros. CEE : 200 euros. Reste a charge : 2 197 euros. Devis écrit sur 4 pages, signe, avec attestation RGE QualiPAC valide jusqu'au 12 mars 2027.",
    },
    faq: [
      {
        q: "Mon plombier doit-il etre RGE pour les aides MaPrimeRenov' ?",
        r: "Oui obligatoire pour PAC, chauffe-eau thermodynamique, solaire. Pour un cumulus électrique standard : non, mais pas d'aide non plus. Verifiez la qualification spécifique (QualiPAC, QualiSol, PG, etc.) sur france-renov.gouv.fr.",
      },
      {
        q: "Combien coute une intervention en urgence (nuit, dimanche, férié) ?",
        r: "Majoration légale jusqu'a 100 pourcents du tarif jour ouvre. Une fuite d'eau simple : 200 a 600 euros la nuit. Au-dela, exigez devis écrit avant intervention (obligation légale plus de 100 euros TTC).",
      },
      {
      ...
      },
      {
        ...
        r: "Un multitravaux ('homme a tout faire') n'a souvent pas la décennale plomberie ni les habilitations gaz. Pour un robinet ou une fuite mineure : peut suffire. Pour une chaudiere, salle de bain complète, gaz : plombier qualifie obligatoire.",
      },
      {
        q: "Combien de devis demander avant de signer ?",
        r: "Trois devis comparables est la règle d'or. Ecart superieur a 30 pourcents entre eux : creusez. Soit le plus cher gonfle, soit le moins cher coupe les coins. Le devis median est souvent le plus fiable.",
      },
    ],
    sources: [
  ...
  {
    metier: "electricien",
    titre: "Comment choisir un bon électricien",
    meta_description: "Habilitation, NF C 15-100, Consuel : les critères pour choisir un électricien fiable. Drapeaux rouges et questions a poser. Guide editorial 2026.",
    intro: "L'électricité est silencieuse jusqu'a la panne, l'incendie ou le choc électrique. Un mauvais électricien peut faire passer une installation pour conforme alors qu'elle ne l'est pas , et la sanction tombe le jour du sinistre, quand l'assurance refuse sa garantie. Voici comment choisir, etape par etape.",
    enjeu: "30 pourcents des incendies domestiques en France sont d'origine électrique (source ONSE 2024). La norme NF C 15-100, mise a jour amendement A5 en 2021, s'impose a toute installation neuve ou refaite. Le Consuel atteste la conformité. Sans Consuel, votre assurance peut tout simplement ne pas couvrir un sinistre.",
    criteres: [
      {
        titre: "Habilitation électrique en cours de validité",
        description: "B1V, B2V, BR, BC selon les niveaux. L'électricien doit afficher une carte d'habilitation a jour (recyclage tous les 3 ans). Sans ca, il n'a meme pas le droit de retirer un disjoncteur.",
        niveau: "critique",
      },
      {
        titre: "Décennale spécialité courant fort + faible",
        description: "Verifiez que la mention 'électricité' figure dans le contrat decennal. Certains contrats excluent la domotique ou les courants faibles , a vérifier si vous installez une alarme ou de la fibre.",
        niveau: "critique",
      },
      {
        titre: "NF C 15-100 amendement A5 maitrise",
        description: "L'amendement A5 (2021) impose disjoncteurs differentiels 30 mA partout, parafoudre obligatoire en zone AQ2, points lumineux DCL conformes. Posez cette question , reponse vague = électricien depasse.",
        niveau: "critique",
      },
      {
      ...
      {
        titre: "Consuel après travaux significatifs",
        description: "Pour tout remplacement de tableau électrique ou nouveau circuit principal, le Consuel atteste la conformité. Un électricien serieux intégré la demande Consuel dans son forfait. S'il ne le fait pas : signal.",
        niveau: "elevee",
      },
      {
        titre: "Photos de tableaux precedents et réseaux propres",
        description: "Un tableau électrique bien fait, c'est de l'art. Les fils alignes, etiquetes, peignes propres. Demandez des photos. Un tableau spaghetti = mauvais électricien.",
        niveau: "utile",
      },
    ],
    drapeaux_rouges: [
      ...
      "Devis sans 'Consuel obligatoire après travaux' alors que vous changez le tableau ou ajoutez un circuit principal.",
    ...
    questions_devis: [
      {
        ...
        r: "L'électricien serieux saura citer : disjoncteur differentiel 30 mA par groupe, parafoudre si AQ2, points lumineux DCL, prises 16A min. par pièce. Si flou : il ne suit pas la norme.",
      },
      {
        q: "Le Consuel est-il intégré au devis ou en supplement ?",
        r: "Un électricien qui ne proposé pas le Consuel sur travaux significatifs vous expose. Cout standard : 130 a 200 euros. Doit etre dans le devis.",
      },
      {
      ...
      },
      {
        ...
        r: "Si vous prevoyez une voiture électrique dans 5 ans, l'électricien peut anticiper le passage en triphase 18 ou 36 kVA. Couts marginaux maintenant, évite des travaux 2x plus chers ensuite.",
      },
      {
        q: "Avez-vous fait un test isolement avant de me remettre l'installation ?",
        r: "Un test megger (mesure de la resistance d'isolement) doit etre fait. Resultat consigne sur le PV de réception. Sans ca : votre assurance peut refuser sa garantie en cas de court-circuit.",
      },
    ],
    cas_concret: {
      titre: "Anatomie d'un tableau électrique aux normes : appartement 70 m2",
      texte: "Sur la fiche pro Paris 75011, le tableau livré comprend : 1 disjoncteur d'abonne 60A monophase, 4 interrupteurs differentiels 30 mA type AC pour circuits prises et éclairage, 2 type A pour lave-linge et plaque cuisson (obligatoires sur ces appareils), 1 type B (Hi-FI ou IRVE), 12 disjoncteurs divisionnaires (éclairage, prises pièce, four, plaques, lave-linge, lave-vaisselle, secheur, chauffage, IRVE), 1 parafoudre type 2 (zone AQ1 mais recommande en agglomeration). PV Consuel obtenu en 8 jours. Devis : 2 350 euros HT pose + 480 euros materiel = 2 830 euros HT.",
    },
    faq: [
      {
        q: "Quand le Consuel est-il obligatoire ?",
        r: "Pour tout remplacement complet d'un tableau électrique, ajout de nouveau circuit principal, ou installation neuve. Sans Consuel valide : Enedis ne raccorde pas le compteur. Cout 130 a 200 euros, dans le devis.",
      },
      {
        q: "Qu'est-ce que la norme NF C 15-100 ?",
        r: "Norme française des installations électriques basse tension. Amendement A5 (2021) en vigueur. Principaux points : disjoncteurs differentiels 30 mA, parafoudre AQ2, points lumineux DCL, hauteur prises, sections cables. Tout électricien doit la connaitre par coeur.",
      },
      {
        q: "Mise aux normes complète : combien ca coute ?",
        r: "700 a 1 500 euros pour un tableau seul (T2 standard). 1 500 a 3 000 euros pour un tableau plus refonte de cablage. 2 500 a 5 000 euros pour une refonte totale (cables, prises, points lumineux). Voir notre /tarifs/électricien/.",
      },
      {
        q: "Mon ancien proprio n'a pas refait l'électricité : qui paie ?",
        r: "Achat dans l'ancien : c'est a l'acheteur. Le diagnostic plomb-amiante-électricité des plus de 15 ans est fourni au compromis , il signale les défauts mais n'oblige pas. Vendre : pas d'obligation sauf bail location longue duree.",
      },
      {
        q: "Combien de prises par pièce selon la norme ?",
    ...
    sources: [
      ...
      { label: "Consuel , attestation conformité", url: "https://www.consuel.com/" },
  ...
  // ============================================================
  {
    ...
    criteres: [
      {
        titre: "Décennale spécialisée couverture-zinguerie",
        description: "Toutes les decennales ne couvrent pas la couverture. Demandez l'attestation precise. Un couvreur sans décennale couverture est juste interdit d'exercer.",
        niveau: "critique",
      },
      {
        titre: "Qualibat 3 chiffres pour couverture",
        description: "Code Qualibat 3122 (couverture metallique), 3132 (charpente bois), 3142 (zinc). Chaque code = competence vérifiée. Verifiable sur qualibat.com.",
        niveau: "critique",
      },
      {
      ...
      },
      {
        ...
        description: "Un couvreur qui grimpe sans harnais et sans echafaudage est en danger , et vous etes responsable civilement s'il chute. Exigez un plan de prevention écrit pour tout chantier de plus de 1 jour.",
        niveau: "critique",
      },
      {
        titre: "Specialite materiau : tuile vs ardoise vs zinc",
        description: "La pose d'ardoise demande un savoir-faire que peu maitrisent. Le zinc joint debout est encore plus rare. Verifiez les références chantiers du couvreur sur le materiau exact prevu.",
        niveau: "elevee",
      },
      {
    ...
    drapeaux_rouges: [
      ...
      "Acompte 50 pourcents ou plus a la signature , illégal pour artisan BTP (max 30 pourcents).",
    ],
    questions_devis: [
      {
        q: "Quelle est la marque exacte des tuiles ou ardoises proposées, et leur garantie fabricant ?",
        r: "Tuiles terre cuite Imerys, Edilians, Monier : 100 ans garantie gel. Ardoise naturelle Espagne ou Angers : 75-100 ans. Refusez 'tuiles standard' sans référence, souvent du low cost qui se gele en 10 ans.",
      },
      {
        q: "Quel ecran sous-toiture HPV est pose, et a quelle pente ?",
        r: "Tout couvreur serieux pose un ecran HPV (haute permeabilite a la vapeur, exemple : Delta-Vent S, Tyvek Supro). Marque + référence + grammage > 100 g/m2 doivent etre au devis.",
      },
      {
        q: "La charpente sera-t-elle inspectee, et si pourrie, comment est-elle reprise ?",
        r: "Inspection obligatoire avant pose. Si chevrons pourris : reprise au cas par cas. Couvreur serieux intégré une provision (10 a 20 pourcents) au devis pour reprises potentielles.",
      },
      {
        q: "Combien de temps de chantier, et qui s'occupe du nettoyage et de l'evacuation des dechets ?",
        r: "100 m2 de toiture : 10 a 15 jours ouvres + nettoyage. L'evacuation des dechets (ancienne couverture) est a la charge du couvreur. Cout intégré. Refusez s'il facture en plus.",
      },
      {
        q: "Avez-vous déjà fait des chantiers identiques (meme materiau, meme pente) il y a plus de 10 ans ?",
        r: "Une vraie référence : 'oui, j'ai pose 80 m2 de tuiles Edilians chez M. Dupont en 2014, vous pouvez l'appeler'. Pas une référence : 'oui souvent'.",
      },
    ],
    cas_concret: {
      titre: "Anatomie d'un chantier reussi : refection toiture 120 m2 tuile + ITE",
      texte: "Sur la fiche pro Auxerre 89000, le couvreur livré : depose 120 m2 de tuiles canal mediterraneenes anciennes (1985), reprise de 8 chevrons pourris (provision atteinte), pose d'un ecran HPV Delta-Vent S, isolation par sarking (panneaux laine de bois 200 mm R = 5,3), pose tuiles canal Edilians neuves grain naturel. Echafaudage type S pour 14 jours. Total : 22 800 euros HT, soit 25 080 euros TTC (TVA 5,5 RGE). MaPrimeRenov' menages modestes : 7 200 euros. CEE Coup de Pouce : 1 800 euros. Reste a charge : 16 080 euros. ROI énergie : 380 euros par an, ROI 30 ans (mais surtout patrimoine valorise plus de 30 000 euros au DPE).",
    },
    faq: [
      {
        q: "Quand faut-il refaire sa toiture ?",
        r: "Tuiles terre cuite : 50 a 100 ans selon climat. Ardoise : 80 a 100 ans. Zinc : 60 a 80 ans. Tole bac acier : 30 a 50 ans. Surveiller : taches d'humidite plafond, tuiles cassees, mousses persistantes après demoussage. Diagnostic gratuit chez la plupart des couvreurs.",
      },
      {
        q: "Refection toiture : faut-il une déclaration en mairie ?",
      ...
      {
        q: "Faut-il faire une isolation par extérieur (sarking) en meme temps ?",
      ...
      {
        q: "Mon assurance couvre-t-elle les degats après tempete ?",
        r: "Oui si arrete catastrophes naturelles + déclaration sous 5 jours. Tuiles arrachees, branches tombees, fuite : indemnises. PAS la vetuste ni les défauts d'entretien. Photos avant/après essentielles.",
      },
      {
        q: "Demoussage de toiture : utile ou arnaque ?",
        r: "Utile tous les 5 a 7 ans en zone humide. Arnaque si vendu après demarchage telephonique a 50 euros/m2 (5x trop cher). Tarif honnete : 8 a 25 euros/m2 selon hydrofuge applique.",
      },
    ],
    sources: [
  ...
  // ============================================================
  {
    ...
    meta_description: "Atelier ou pose seule, décennale, RGE pour fenetres : critères pour choisir un menuisier fiable. Questions devis et FAQ. Guide editorial 2026.",
    intro: "Un menuisier, c'est plusieurs métiers : poseur de fenetres (rénovation thermique), agenceur (cuisines/dressings), charpentier (combles), ebeniste (mobilier). Chaque spécialité a ses critères. Voici comment choisir selon votre projet.",
    enjeu: "Les menuiseries extérieures (fenetres, portes) représentent 10 a 15 pourcents des pertes thermiques. Une fenetre mal posee laisse passer l'air. Une porte d'entrée pas ajustee perd 200 euros par an. Et c'est ce métier qui a le plus de variation prix/qualite : du PVC chinois bas de gamme au chene massif sur-mesure.",
    criteres: [
      {
        titre: "Atelier ou pose seule ? Diagnostiquer le profil",
        description: "Un menuisier avec atelier propre fabrique sur-mesure, avec équipement (raboteuse, scie a panneaux). Un menuisier 'poseur' achete des produits standard. Demandez a visiter l'atelier , revelateur.",
        niveau: "elevee",
      },
      {
      ...
      {
        titre: "Décennale couvrant menuiserie + charpente eventuelle",
        description: "La menuiserie extérieure est couverte par la décennale standard. Mais si vous touchez a la charpente (escalier, comble), la décennale spécifique 'travaux de charpente' est obligatoire.",
        niveau: "critique",
      },
      {
        titre: "Echantillons et photos de réalisations chez clients",
        description: "Un menuisier serieux a toujours des echantillons en bois (chene, hetre, frene, exotique) pour vous toucher la matière. Refusez les choix sur catalogue uniquement.",
        niveau: "elevee",
      },
      {
        titre: "Coefficient Uw des fenetres clairement spécifié",
      ...
      },
      {
        ...
        description: "10 ans décennale + 5 ans constructeur sur étanchéité vitrage isolant + 2 ans sur quincaillerie. Demandez les 3 par écrit.",
        niveau: "utile",
      },
    ],
    drapeaux_rouges: [
      "Menuisier proposé 'pose en rénovation' alors que les dormants sont pourris , obligation de depose totale.",
      "Pas de mention du fabricant des fenetres et de leur certification CSTBat , souvent du low cost imports.",
      "Devis sans mention du coefficient Uw (deperdition thermique) , vous ne pouvez pas vérifier l'éligibilité aux aides.",
      "Pose 'au coup de pige' sans pose de joints periphericiel etanches a l'air , mauvais resultat thermique.",
      "Promesse 'cuisine sur-mesure' a moins de 7 000 euros , c'est forcement un assemblage de pièces standard.",
      "Refus de visite atelier ou prive jamais montree , forcement sous-traitant offshore.",
    ],
    questions_devis: [
      {
        q: "Quel est le fabricant et la référence exacte des fenetres ? Et leur Uw ?",
      ...
      {
        q: "Pose en rénovation ou depose totale ?",
        r: "Rénovation = sur dormant existant, plus rapide, moins cher. Depose totale = nouveau dormant, meilleure étanchéité. Rénovation OK si dormant sain. Si pourri : depose obligatoire (ne pas economiser ici).",
      },
      {
        q: "Comment etes-vous certifié en pose de fenetres ?",
        r: "Demandez la qualification Qualibat menuiserie extérieure (3741) ou la certification fabricant (label Pose Veka, Aluplast Pose+, etc.). Sans cert : risque de pose non conforme et perte de garantie.",
      },
      {
        q: "Sur cuisine sur-mesure : pouvez-vous me montrer une réalisation client récente que je peux visiter ?",
      ...
      {
        q: "Quels sont vos délais de fabrication et de pose, et garanties en cas de retard ?",
        r: "Sur-mesure : 6 a 12 semaines fabrication après signature. Pose : 1 a 3 jours par chantier. Penalites de retard : 1/3000 par jour ouvre du total. Si non spécifié ou refuse : signal.",
      },
    ],
    cas_concret: {
      titre: "Anatomie d'une rénovation 8 fenetres + porte d'entrée",
      texte: "Sur la fiche pro Sens 89100, le menuisier livré : 8 fenetres K-Line aluminium thermolaque gris anthracite, profil 75 mm, double vitrage 4-16-4 argon, Uw 1,28 (éligible MaPrimeRenov'). Pose en depose totale (dormants pourris). 1 porte d'entrée alu inox panel paire de portes A2P BP1. Total : 14 800 euros HT (10 200 fenetres + 4 600 porte). TVA 5,5 (RGE QualiBat 3741, 3742). MaPrimeRenov' : 1 200 euros (8 x 150 menages modestes). CEE Coup de Pouce : 800 euros. Reste a charge : 12 800 euros. Garantie : 10 ans décennale, 5 ans vitrage isolant, 2 ans quincaillerie.",
    },
    faq: [
      {
        q: "PVC, aluminium, bois : comment choisir ?",
        r: "PVC : moins cher, isole bien, entretien zero. Alu : plus cher, plus design, montants plus fins, faiblesse thermique sauf rupture pont thermique. Bois : noble mais entretien tous les 5-10 ans (lasure). Mixte alu/bois : haut de gamme, durabilité + thermique.",
      },
      {
        q: "Faut-il déclarer en mairie le changement de fenetres ?",
        r: "Si modification d'aspect (couleur, dimensions, materiau) : déclaration prealable obligatoire. Si meme aspect : non. Verifiez le PLU local. Copropriete : règlement souvent restrictif.",
      },
      {
        q: "Combien coute une cuisine équipée sur mesure ?",
  ...
  // ============================================================
  {
    ...
    meta_description: "RGE obligatoire, ACERMI, NF DTU : critères pour choisir un poseur d'isolation. Drapeaux rouges du 1 euro et 5 questions a poser.",
    intro: "L'isolation est le geste de rénovation le plus rentable. Et le plus arnaque. La promesse 'isolation a 1 euro' a été supprimée en 2020 mais ses heritiers (1 euro symbolique, 100 euros, etc.) prosperent encore. Voici comment choisir un vrai professionnel pour un chantier qui dure 30 ans.",
    enjeu: "L'isolation des combles perdus rentabilise en 5 a 7 ans grace aux economies de chauffage. Une mauvaise pose : 30 pourcents d'efficacite perdue + risques humidite. Le marché français est inonde d'arnaqueurs depuis MaPrimeRenov' , les sanctions DGCCRF se multiplient mais la vigilance reste imperative.",
    criteres: [
      {
      ...
      },
      {
        ...
        description: "L'isolant doit avoir un certificat ACERMI (Association pour la Certification des Materiaux Isolants). Specifie le R thermique, la conductivite thermique lambda, et la durabilité. Numero ACERMI au devis.",
        niveau: "critique",
      },
      {
      ...
      },
      {
        ...
        description: "Le pare-vapeur empeche la vapeur d'eau de penetrer dans l'isolant. Sans pare-vapeur ou mal pose : isolant trempe en 2 hivers. La pose se fait cote chaud (cote intérieur).",
        niveau: "critique",
      },
      {
        titre: "Resistance thermique R cible (minimum 7 pour combles)",
        description: "MaPrimeRenov' impose R >= 7 m2.K/W pour combles perdus. R >= 6 pour rampants. Verifiez l'épaisseur minimum 200 mm laine soufflee ou 220 mm laine de bois.",
        niveau: "elevee",
      },
      {
        titre: "Photos pre/post chantier avec piges graduees",
        description: "Un isolier serieux place des piges graduees tous les 5 m2 pour contrôle visuel de l'épaisseur posee. Photos avant/après systematiques. Demandez les voir avant signature.",
        niveau: "utile",
      },
    ],
    drapeaux_rouges: [
      "'Isolation a 1 euro' ou prix derisoire avec MaPrimeRenov' surdimensionne , souvent fraude aux aides.",
      "Demarchage telephonique pour 'isolation gratuite' ou 'contrôle thermique offert' , 95 pourcents d'arnaques.",
      "Pas de mention de pare-vapeur ou ventilation , isolation condamnee a court terme.",
      "Pose de polyurethane projete par un artisan non certifié ACERMI projection , risques sanitaires.",
      "Certificat RGE non vérifiable sur france-renov.gouv.fr , faux.",
      "Devis qui ne spécifié ni épaisseur isolant ni resistance thermique R , vous ne pouvez pas vérifier l'éligibilité aides.",
    ],
    questions_devis: [
      {
        q: "Quel isolant exact, et son numero ACERMI ?",
        r: "Refusez 'laine de verre standard'. Exigez : marque (Isover, Knauf, Rockwool, Soprema), référence (Iso Confort 35, Tortue, Comfortbatt), numero ACERMI (vérifiable sur acermi.com), R cible.",
      },
      {
        q: "Comment est posee la ventilation, et est-elle conforme NF DTU 24.1 ?",
        r: "VMC simple flux : 1 bouche par pièce humide. Double flux : plus efficace mais plus cher. Naturelle : grilles d'aeration en facade. Specifie au devis. Sans : risque condensation.",
      },
      {
      ...
      {
        q: "Quel est le délai de chantier, et qui evacue les dechets ?",
      ...
      {
        q: "Pouvez-vous me donner 3 références chantiers de moins de 12 mois ?",
        r: "Un poseur serieux fournit référence avec accord client. 'Mme Dupont 89400 Migennes, je peux vous communiquer son numero.' Pas de référence : signal alarme.",
      },
    ],
    cas_concret: {
      titre: "Anatomie d'un chantier isolation combles perdus 100 m2",
      texte: "Sur la fiche pro Sens 89100, le poseur livré : isolation par soufflage de laine de roche Rockwool Jetrock 2, R 7,5 (épaisseur 280 mm soufflee), pare-vapeur Stamisol Eco continu, piges graduees tous les 5 m2 (24 piges visibles). Reprise des trappes accès (3) en isolation pose. VMC simple flux bouches vérifiées. Total : 3 200 euros HT (900 euros pose + 2 100 euros materiel + 200 euros piges et accessoires). TVA 5,5 (RGE QualiBat). MaPrimeRenov' : 1 750 euros (menages modestes 25 euros/m2). CEE Coup de Pouce : 1 000 euros. Reste a charge : 450 euros. ROI : 3 ans grace aux 280 euros par an d'economie chauffage.",
    },
    faq: [
      {
      ...
      },
      {
        ...
        r: "1) Combles perdus (R 7-8) : ROI 5-7 ans. 2) Murs par intérieur (R 4-5) : ROI 8-12 ans. 3) ITE par extérieur (R 4-5) : ROI 12-15 ans mais beneficie a la valorisation patrimoine. 4) Sols (R 3) : ROI 10-15 ans.",
      },
      {
      ...
      {
        q: "Combles amenages : isolation par intérieur ou par extérieur (sarking) ?",
...
GUIDES_METIERS.push({
  ...
  meta_description: "Certifications RGE QualiPAC, QualiBois, F-Gaz : critères pour choisir un chauffagiste fiable. Drapeaux rouges et questions a poser, guide 2026.",
  intro: "Le chauffagiste pose et entretient ce qui représente 60 a 70 pourcents de votre facture énergie. Mauvais choix : pompe a chaleur surdimensionnee, chaudiere mal regulee, contrat d'entretien abusif. Voici comment trouver le bon.",
  enjeu: "MaPrimeRenov' a transforme le marché : 5 000 euros d'aide possibles sur une PAC air-eau, mais OBLIGATOIREMENT via un artisan RGE QualiPAC. Sans cette certification, vous perdez les aides et la décennale spécifique pompes a chaleur.",
  criteres: [
  ...
  drapeaux_rouges: [
    ...
    "Pas de mention F-Gaz sur devis PAC ou clim , artisan illégal sur fluides frigorigenes.",
    "Refus de communiquer le COP/ETAS en condition climat realiste (a -7 degC) , materiel sous-performant.",
  ],
  questions_devis: [
    { q: "Quel est le COP a -7 degC ou l'ETAS de la PAC proposée ?", r: "MaPrimeRenov' impose ETAS >= 126 pourcents. COP nominal a -7 degC : 3,5 minimum. Refusez les COP donnes a +7 degC, biaises." },
    { q: "Avez-vous fait un bilan thermique avant ce devis ?", r: "Reponse esperee : oui, méthode 3CL avec rapport écrit. Si flou : risque surdimensionnement majeur." },
    { q: "Quelle est l'unite extérieure proposée, et son niveau sonore en dB(A) ?", r: "35 a 50 dB(A) typique. Règlement copropriete et arrete bruit voisinage a vérifier. Au-dessus de 45 dB(A) : risque litige voisin." },
    { q: "Quel est le délai SAV en cas de panne, et qui le prend en charge ?", r: "Décennale obligatoire + garantie compresseur 5 a 10 ans constructeur. Delai intervention SAV : 48h ouvrees max. A spécifier au devis." },
  ],
  cas_concret: {
    titre: "Anatomie d'une pose PAC air-eau 11 kW",
    texte: "Sur la fiche pro Auxerre 89000, le chauffagiste livré : Daikin Altherma 3 H HT 11 kW haute temperature, COP 3,7 a -7 degC, ETAS 132 pourcents. Bilan thermique 3CL prealable. Depose ancienne chaudiere fioul 18 ans, decuve 2000 L. Pose unite ext 38 dB(A) sur dalle isolante anti-vibrations. Reseau radiateurs basse temp adapte. Total : 14 200 euros HT (10 800 materiel + 3 400 pose). TVA 5,5 (RGE). MaPrimeRenov' : 4 000 euros. CEE Coup de Pouce : 4 500 euros. Reste a charge : 5 700 euros.",
  },
  faq: [
    ...
    { q: "Mon ancienne chaudiere fioul est-elle encore légale ?", r: "Oui en 2026, mais interdite a remplacer par une fioul depuis juillet 2022. Si elle tombe en panne : passage obligatoire a PAC, gaz, ou bois. MaPrimeRenov' Coup de Pouce spécifique pour sortir du fioul." },
    { q: "L'entretien chaudiere est-il vraiment obligatoire ?", r: "Oui pour gaz, fioul, bois (décret 2009-649). Locataire a la charge sauf bail. Sans attestation a jour : assurance habitation peut refuser garantie en cas de sinistre." },
...
GUIDES_METIERS.push({
  ...
  meta_description: "Décennale, isolation phonique, plaques A1 ignifuge : critères pour choisir un plaquiste fiable. Drapeaux rouges et 4 questions a poser.",
  ...
  enjeu: "Le placo est un métier d'apparence simple mais technique. Les plaques BA13 standard, hydrofuges, phoniques, ignifuges ont chacune leur usage spécifique. Une mauvaise plaque dans une salle de bain = moisissures sous 3 ans. Un mauvais joint = fissures.",
  criteres: [
    { titre: "Décennale travaux de cloisonnement", description: "La décennale standard couvre. Verifiez la mention 'cloisons et plafonds' au contrat.", niveau: "critique" },
    { titre: "Connaissance des plaques specialisees", description: "BA13 standard pour murs intérieurs secs. Hydrofuge pour pièces humides. Phonique pour double cloison. Ignifuge pour ERP. Le plaquiste doit connaitre la matrice.", niveau: "critique" },
    { titre: "Maitrise pose ossatures metalliques", description: "Rails et montants F47 ou C48. Ecartement maximal 60 cm pour BA13, 40 cm pour double couche. Verifiez les références.", niveau: "elevee" },
    ...
    { titre: "Photos chantier de plus de 5 ans", description: "Plaquiste serieux a des références avec finition impeccable après 5 ans. Pas de fissures, pas de joints visibles.", niveau: "utile" },
  ],
  drapeaux_rouges: [
    "Pose de plaques standard en salle de bain , doivent etre hydrofuges (BA13 vert ou bleu).",
    "Refus d'expliquer le type de plaque pose pour chaque pièce , generaliste qui ne maitrise pas.",
  ...
  questions_devis: [
    { q: "Quelle plaque pour quelle pièce ?", r: "Salle de bain : BA13 hydrofuge. Cuisine : BA13 hydrofuge ou standard hauteur 2 m + hydro au-dessus. Chambre : standard. Garage adjacent : ignifuge BA13 BS." },
    { q: "Quelle épaisseur d'isolation intérieure proposée ?", r: "ITI 100 mm laine de verre = R 2,5. 120 mm = R 3. 160 mm laine de bois = R 4. Pour MaPrimeRenov' : R >= 3,7 minimum." },
    { q: "Comment poser le pare-vapeur ?", r: "Cote chaud (intérieur), continu, jonctions par bandes adhesives etanches. Autour des prises et interrupteurs : manchettes etanches. Sans : isolation perdue en 3 ans." },
    { q: "Avez-vous déjà pose des cloisons phoniques (Rw plus de 50 dB) ?", r: "Une cloison phonique est un métier dans le métier. Double ossature desolidarisee + double couche placo + laine de roche. Si flou : choisissez un spécialiste." },
  ],
  cas_concret: {
    titre: "Anatomie d'un doublage isolation intérieure 50 m2",
    texte: "Sur la fiche pro Sens 89100, le plaquiste livré : ossature metallique F47 ecartement 60 cm, isolation laine de verre Isover 120 mm R = 3,75, pare-vapeur Vario Knauf, plaque BA13 standard. Joints bande papier + enduit Knauf, ponce, pret a peindre. Total : 3 800 euros HT pour 50 m2 (76 euros/m2). TVA 10 (rénovation). Eligible MaPrimeRenov' ITI : 750 euros. ROI thermique : 4 a 6 ans en zone H1.",
  },
  faq: [
    { q: "Cloison ou mur porteur, quelle difference ?", r: "Cloison : non porteuse, en placo ou parpaing leger. Mur porteur : structurel, en parpaing 20 cm ou plus. Le plaquiste pose des cloisons. Toucher a un mur porteur = maçon avec étude beton arme." },
    ...
    { q: "Combien de temps pour 30 m2 cloison ?", r: "1 a 2 jours travaux + 1 jour finition (joints, ponce). Total 2 a 3 jours pour pièce complète. Sechage joints 24 h avant peinture." },
  ],
  sources: [
...
GUIDES_METIERS.push({
  ...
  questions_devis: [
    { q: "Quel SPEC est utilise en pièces humides ?", r: "SPEC Mapei Kerakoll, Weber.tec, Sika MonoSeal. Reference + ATEx au devis. Sans SPEC en SDB : refusez." },
    { q: "Joint ciment ou epoxy en douche ?", r: "Epoxy obligatoire en douche italienne. Ciment classique en sol pièces seches. Le carreleur doit savoir argumenter le choix." },
    ...
    { q: "Quel ecartement entre carreaux pour le grand format ?", r: "2 mm minimum (NF DTU 52.2). Le rectifie permet jusqu'a 1 mm. Refusez 'sans joint' , illégal et fissures garanties." },
  ],
  cas_concret: {
    titre: "Anatomie d'une douche italienne 80x140 cm",
    texte: "Sur la fiche pro Auxerre 89000, le carreleur livré : depose carrelage existant + chape, ragreage Mapei Ultraplan Eco (5 mm), SPEC Mapei Mapegum WPS (membrane étanchéité), pose carrelage gres cerame imitation marbre 60x60 (15 mm joints), joint epoxy Mapei Kerapoxy (gris). Pente 1,5 pourcents vers caniveau. Total 8 000 euros TTC TVA 10. Garantie 10 ans (décennale + chape) + 5 ans constructeur joint epoxy.",
  },
  faq: [
...
GUIDES_METIERS.push({
  ...
  criteres: [
    ...
    { titre: "Maitrise NFT 36-005 finitions", description: "La norme classifie les finitions : A (impeccable), B (courante), C (economique). Au devis, exigez 'finition A' pour pièces a vivre.", niveau: "critique" },
    { titre: "Peintures classees A+ COV bas", description: "COV = Composes Organiques Volatiles. A+ (moins de 1000 microgrammes/m3) recommande pour intérieur. Marques : Tollens, Seigneurie, Allios, Astral.", niveau: "elevee" },
  ...
  drapeaux_rouges: [
    ...
    "Peintures sans certification A+ ou marque inconnue , risque odeurs et durabilité limitee.",
  ...
  cas_concret: {
    ...
    texte: "Sur la fiche pro Sens 89100, le peintre livré : protection sols films + bache mobilier, lessivage murs + plafond, rebouchage 2 fissures legeres, ponce 240 grain, sous-couche Tollens Phenix Sub Adhesive (1 couche), finition Tollens Phenix Velours blanc (2 couches mat). 30 m2 mur + 25 m2 plafond. Total : 1 350 euros TTC (45 euros/m2 mur fini, 22 euros/m2 plafond). TVA 10 (rénovation). Sechage 24h avant utilisation, 7 jours mobilier lourd.",
  },
  faq: [
    ...
    { q: "Peinture decorative vs standard ?", r: "Standard : 25 a 50 euros/m2. Decorative (effet ferre, beton cire, tadelakt, stuc venitien) : 50 a 250 euros/m2. ROI deco : 1 pièce focal max, sinon casse l'unite." },
...
GUIDES_METIERS.push({
  ...
  criteres: [
    ...
    { titre: "Devis ECRIT obligatoire au-dela de 100 euros TTC", description: "Article L.111-1 Code conso. Sans devis écrit signe : intervention illégale. Vous pouvez refuser de payer.", niveau: "critique" },
    { titre: "Numero SIRET visible sur fourgon et flyer", description: "Sirenable sur sirene.gouv.fr ou via /outils/vérifier-siret/. Une entreprise active avec plus de 5 ans = signal fiabilite.", niveau: "elevee" },
  ...
  drapeaux_rouges: [
    ...
    "Refus de devis écrit pour intervention superieur a 100 euros TTC , illégal.",
    "Casse systematique de la serrure sans tenter manipulation manuelle , deplacement gonflé.",
    "Vente de cylindre 'haute securite' a 600 euros + pose 400 euros , prix 5x marché normal.",
  ...
  faq: [
    ...
    { q: "Comment recourir contre une surfacturation ?", r: "1) Refusez de payer plus que le devis écrit. 2) Si paiement CB ou cheque : Banque de France peut bloquer. 3) Saisir DGCCRF (signalconso.fr). 4) Plainte pour escroquerie au commissariat." },
    ...
    { q: "Faut-il ouvrir la porte avant l'arrive du serrurier ?", r: "Non. Pas de cle, pas de force. Attendez. Si urgence (enfant a l'intérieur, gaz qui fuit) : pompiers gratuit." },
  ],
  sources: [
...
GUIDES_METIERS.push({
  ...
  meta_description: "Décennale, Qualibat, NF EN 206-1 : critères pour choisir un macon fiable. Drapeaux rouges et questions a poser, guide editorial 2026.",
  intro: "Le macon construit ce qui dure 100 ans. Mauvais macon : fissures, infiltrations, mur qui s'incline en 5 ans. Le métier est dur a evaluer pour un particulier. Voici comment trier le bon grain.",
  enjeu: "Une fondation, un mur porteur, une dalle : tout est statique et se voit pas avant 10 ans. La décennale couvre, mais la procedure est longue (3-5 ans avant indemnisation). Mieux vaut bien choisir des le depart.",
  criteres: [
  ...
  drapeaux_rouges: [
    ...
    "Pas d'étude beton arme pour ouvrage de plus de 5 m , fissures garanties dans 5 ans.",
  ...
  questions_devis: [
    { q: "Quel dosage cimentier (en kg/m3) pour le beton ?", r: "250 kg/m3 = beton proprete. 350 kg/m3 = beton arme. 400 kg/m3 = beton hautes performances. A spécifier au devis selon usage." },
    ...
    { q: "Avez-vous fait une étude beton pour mon mur de soutenement ?", r: "Tout mur de plus de 1,50 m exige étude beton arme. Bureau d'études (~600 a 1 200 euros) externe au macon. Sans étude : refus." },
  ],
  cas_concret: {
    titre: "Anatomie d'une dalle beton 50 m2 garage",
    texte: "Sur la fiche pro Auxerre 89000, le macon livré : decapage terre vegetale 30 cm, lit drainage galets 20 cm, treillis double 5x5 cm, beton 350 kg/m3 épaisseur 15 cm dose chez Lafarge avec bon de pesee. Joints dilatation a 5 m. Niveau laser. Total : 4 200 euros HT (84 euros/m2). TVA 10. Sechage 21 jours avant carrelage, 28 jours pour charge complète. Garantie décennale.",
  },
  faq: [
    { q: "Combien coute un mur en parpaing ?", r: "80 a 180 euros/m2 selon hauteur, épaisseur (15, 20 ou 25 cm) et chainage. Voir /tarifs/macon/. Mur de cloture jusqu'a 2 m sans déclaration; au-dela DP." },
    ...
    { q: "Combien de temps de sechage avant carrelage sur dalle neuve ?", r: "21 jours pour un beton standard. 28 jours pour réception complète avec charge. Eau libre dans le beton fait gonfler le carrelage." },
    { q: "Mur porteur ou cloison ?", r: "Mur porteur supporte plancher/toiture, fondations renforcees, décennale spécifique. Cloison : aucun role structurel, en placo ou parpaing leger." },
  ],
  sources: [
...
GUIDES_METIERS.push({
  ...
  meta_description: "Certiphyto, décennale, credit impot SAP : critères pour choisir un jardinier-paysagiste fiable. Drapeaux rouges et 4 questions a poser.",
  ...
  enjeu: "Le service a la personne (SAP) jardin beneficie de 50 pourcents de credit d'impot jusqu'a 5 000 euros/an. C'est un avantage fiscal majeur , mais réservé aux entreprises déclarées Cesu ou organismes agrees. Vérifier l'éligibilité est crucial.",
  criteres: [
    { titre: "Cesu ou organisme agrement SAP", description: "Pour beneficier du credit d'impot 50 pourcents, l'entreprise doit etre déclarée au registre national SAP. Verifiable sur servicesalapersonne.gouv.fr.", niveau: "critique" },
    { titre: "Certiphyto si traitements phytosanitaires", description: "Pour pulveriser désherbants, fongicides, insecticides : certificat Certiphyto obligatoire. Sans : intervention illégale. Acces public www.actiphytotraite.fr.", niveau: "critique" },
    { titre: "MSA ou URSSAF déclarés (cotisation)", description: "Une entreprise qui déclaré ses salariés paie MSA (mutualite sociale agricole) ou URSSAF. Au noir : pas d'assurance, pas de credit impot, ouvrier non couvert.", niveau: "elevee" },
    { titre: "Materiel propre et bien entretenu", description: "Tondeuses, taille-haies, tronconneuses électriques bien afflutees = travail propre. Materiel rouille ou casse : signal de bricolage.", niveau: "elevee" },
    { titre: "Photos jardin avant/après et entretien duree", description: "Jardin entretenu 3 ans plus tard avec haie taillee impeccablement : signal qualite. Photos avant/après systematiques.", niveau: "utile" },
  ],
  drapeaux_rouges: [
    "Pas déclaration Cesu ou SAP , pas de credit d'impot, signal au noir.",
    "Traitement chimique sans Certiphyto , illégal et risques sanitaires.",
    "Devis sans facture (paiement especes) , au noir, vous etes complice.",
    "Tronconnage arbre sans équipement (harnais, casque, protections) , danger pour vous et eux.",
  ...
  cas_concret: {
    ...
    texte: "Sur la fiche pro Sens 89100, le paysagiste livré : contrat annuel jardin 1000 m2 (10 ares). 4 visites mensuelles avril-octobre, 2 par mois novembre-mars (24 visites/an). Tonte, taille haies, debroussaillage, ramassage feuilles. Certiphyto : oui. Forfait 2 400 euros TTC/an. Eligible credit impot 50 pourcents = reste a charge 1 200 euros. Materiel apporte. Compostage sur place.",
  },
  faq: [
    ...
    { q: "Quand planter ?", r: "Octobre a mars hors gel : plants en racines nues (moins chers). Toute l'année : plants en pot. Eviter été (chaleur stress). Charmille pousse 1m/an, laurier 1,5m/an." },
...
GUIDES_METIERS.push({
  ...
  meta_description: "F-Gaz, QualiPAC, fluide R32 : critères pour choisir un climaticien fiable. Drapeaux rouges et 4 questions a poser, guide editorial 2026.",
  ...
  criteres: [
    ...
    { titre: "Photos chantiers et niveau sonore unite ext", description: "35 a 50 dB(A). Règlement copropriete + arrete bruit voisin a vérifier. Photos chantiers anciens : qualite installation visible.", niveau: "utile" },
  ],
  drapeaux_rouges: [
    "Pas de certification F-Gaz Cat 1 , illégal et garantie nulle.",
    "Promesse 'pose simple sans bilan thermique' , surdimensionnement et facture électrique gonflee.",
    "Fluide proposé : R22 (retiré 2010) ou R410A (en sortie progressive) , prevoir remplacement futur cher.",
    "Pas de mention règlement copropriete pour pose unite ext sur facade , risque AG annule pose.",
  ...
  cas_concret: {
    ...
    texte: "Sur la fiche pro Auxerre 89000, le climaticien livré : Daikin Comfora ATXM35R 3,5 kW reversible, fluide R32, COP chauffage 4,3 a 7 degC, EER refroid 3,7. Bilan thermique 3CL avant. Pose unite ext 35 dB(A) sur dalle isolante anti-vibrations, hauteur > 1 m sol. Liaison cuivre 5 m. Niveau sonore unite int 19 dB(A) silence. Total : 2 800 euros HT. TVA 10 (reno). Garantie 2 ans constructeur fabricant + 5 ans pièces compresseur + 10 ans décennale installation.",
  },
  faq: [
    { q: "MaPrimeRenov' couvre-t-elle la climatisation ?", r: "Plus depuis 2022 (climatiseurs reversibles seuls exclus). Restent : CEE Coup de Pouce 50-200 euros si remplacement chaudiere, et eco-PTZ jusqu'a 30 000 euros bouquet rénovation." },
    ...
    { q: "Entretien annuel obligatoire ?", r: "Oui pour tout système plus de 4 kW (décret 2020-912). 1 visite tous les 2 ans. Cout 100-220 euros. Sans visite : performance baisse, garantie constructeur peut etre annulee." },
  ],
  sources: [
    { label: "ADEME F-Gaz réglementation", url: "https://www.ademe.fr/" },
...
GUIDES_METIERS.push({
  ...
  meta_description: "Pose interne, garanties, paiement securise : critères pour choisir un cuisiniste fiable. Drapeaux rouges et questions a poser.",
  intro: "Une cuisine, c'est 5 000 a 30 000 euros, 8 a 12 semaines de fabrication, et 20 ans de quotidien. C'est l'achat le plus engageant après l'immobilier. Le cuisiniste qui pose bien fait economiser des années de regrets.",
  enjeu: "Le marché cuisine est domine par les enseignes (Schmidt, Mobalpa, Cuisinella, IKEA Pose). Les écarts qualite/prix sont enormes. Comprendre l'intégration verticale (fabrication, pose, SAV) est essentiel pour éviter les mauvaises surprises.",
  criteres: [
    { titre: "Pose interne ou sous-traitée ?", description: "Pose interne (avec poseurs salariés) = SAV reactif. Pose sous-traitée (intermittents, auto-entrepreneurs) = SAV plus difficile. Demandez explicitement.", niveau: "critique" },
    { titre: "Garantie caissons et plan de travail (5 ans min)", description: "Décennale obligatoire installation. Constructeur : 5 ans caissons (Schmidt, Mobalpa premium), 2 ans appareils, 10 ans plan quartz/granit. Au devis.", niveau: "critique" },
    ...
    { titre: "SAV interne et délais reaction", description: "Intervention SAV : 7 a 14 jours ouvres max. Avec poseurs salariés en regie : reactif. Avec sous-traitants : délais peuvent monter a 2-3 mois.", niveau: "elevee" },
  ...
  drapeaux_rouges: [
    "Promesse 'cuisine sur-mesure' a moins de 7 000 euros , c'est forcement assemblage de pièces standard.",
    "Demande 100 pourcents acompte avant fabrication , refusez systematiquement.",
    "Refus de signer plan 3D et metrage definitif , risque écart entre devis et facture.",
    "Pose sous-traitée a auto-entrepreneur sans garantie SAV , reactivite SAV nulle.",
    "Marque inconnue ou 'fabrication europeenne' sans precision , souvent imports asiatiques.",
  ],
  questions_devis: [
    { q: "Vos poseurs sont-ils salariés internes ou sous-traitants ?", r: "Salaries : SAV reactif, formation continue. Sous-traitants : moins controlable. Le cuisiniste serieux est transparent." },
    { q: "Quel sont les délais de fabrication et de pose ?", r: "Sur-mesure standard : 6 a 10 semaines. Premium : 10 a 14 semaines. Pose : 2 a 4 jours selon complexite. Penalites de retard : 1/3000 par jour ouvre." },
    { q: "Quelle est la garantie sur caissons, faces et plan de travail ?", r: "Caissons : 5 ans (premium 10 ans). Faces : 2 a 5 ans. Plan quartz/granit : 10 ans. Electromenager : 2 ans + extensions possibles. Demandez par écrit." },
    { q: "Comment se passe le SAV après pose en cas de probleme ?", r: "Numero direct cuisiniste poseur, intervention sous 7-14 j ouvres. Defaut visible réception : retouche immédiate ou demarche garantie." },
  ],
  cas_concret: {
    titre: "Anatomie d'une cuisine sur mesure 4 m + ilot",
    texte: "Sur la fiche pro Sens 89100, le cuisiniste livré : cuisine en L 4,2 ml + ilot 1,8 m, faces laque mat blanc Schmidt, caissons stratifie, plan quartz Silestone Eternal Calacatta Gold (4 m + ilot 1,8 m), credence carrelage metro. Electromenager : four pyrolyse, plaque induction 4 zones, hotte ilot 60 dB, lave-vaisselle 14 couverts. Total : 17 800 euros TTC. Acompte 30 pourcents 5 340 euros. Fabrication 8 semaines. Pose 2,5 jours. Garantie 5 ans caissons + 10 ans quartz + 2 ans électroménager.",
  },
  faq: [
    { q: "Combien coute une cuisine équipée ?", r: "Standard IKEA-type : 3 500 a 6 000 euros. Moyen de gamme Schmidt/Cuisinella : 6 000 a 12 000 euros. Premium Mobalpa/Bulthaup : 14 000 a 30 000 euros. Voir /tarifs/cuisiniste/." },
    ...
    { q: "Faut-il pour avoir un ilot central ?", r: "Passage minimum autour : 1 m, 1,2 m recommande. Sur dalle : plomberie possible. Sur plenum : éviter, complexe. Hotte ilot ajoute 1 500 a 3 000 euros." },
    { q: "Quel est le délai de fabrication ?", r: "8 a 12 semaines après metrage definitif (16 semaines en haute saison). Pose 2-4 jours après fabrication. Total 3 a 4 mois entre signature et utilisation." },
  ],
  sources: [
    { label: "FCC Fédération cuisinistes", url: "https://www.fcc-france.fr/" },
...
GUIDES_METIERS.push({
  ...
  meta_description: "UFFEP membre, décennale, vitrification : critères pour choisir un parqueteur fiable. Drapeaux rouges et 4 questions a poser, guide 2026.",
  intro: "Un parquet bien pose dure 50 a 100 ans. Mal pose : grincements, bombements, lames qui s'ecartent en 5 ans. Le métier est spécifique , peu d'artisans le maitrisent vraiment. Voici comment trier.",
  ...
  criteres: [
    { titre: "Membre UFFEP ou Fédération Francaise du Bois", description: "L'UFFEP regroupe les vrais parqueteurs. Cotisants : artisans formes a la NF DTU 51.2 (parquet) et 51.3 (revetements). Verifiable uffep.fr.", niveau: "critique" },
    { titre: "Décennale spécifique parquetage", description: "Verifiez 'pose de parquet et revetements bois' au contrat decennal. Sans : parqueteur improvise.", niveau: "critique" },
  ...
  questions_devis: [
    ...
    { q: "Quelle garantie sur la pose et les materiaux ?", r: "Décennale 10 ans pose. Garantie constructeur parquet : 10-30 ans (Tarkett, Quick-Step) ou 25-50 ans (massif). Vitrification : 5-10 ans usage normal." },
  ],
  cas_concret: {
    titre: "Anatomie d'une pose parquet massif chene 30 m2",
    texte: "Sur la fiche pro Auxerre 89000, le parqueteur livré : depose ancien linoleum, ragreage Mapei Ultraplan Eco (3 mm), pose collee chene massif Tarkett Heritage 22 mm largeur 110 mm, motif a l'anglaise, bouche-pores Bona Naturale + 3 couches Bona Mega Wave polyurethane mat. Joints dilatation perimetral 10 mm. Plinthes assorties. Total : 3 200 euros TTC (107 euros/m2 tout compris). Garantie 10 ans pose + 30 ans constructeur Tarkett.",
  },
  faq: [
    ...
    { q: "Combien de fois peut-on poncer un parquet ?", r: "Massif 22 mm : 4 a 6 fois (100 ans). Contrecolle 4 mm couche d'usure : 1-2 fois (50 ans). Vérifier avant ponce que la couche d'usure le permet." },
