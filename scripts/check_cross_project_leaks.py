...
# ---------------------------------------------------------------------------
SELF_PROJECT = {
    "name": 'lobservatoiredespros',
    "supabase_ref": 'apuyeakgxjgdcfssrtek',
    "domain": 'lobservatoiredespros.com',
    "cf_pages_project": 'lobservatoiredespros',
    "own_tokens": {"L'Observatoire des Pros", 'adapte-toi.com', 'lobservatoiredespros.com'},
    "own_domains": {'adapte-toi.com', 'lobservatoiredespros.com'},
    "own_supabase_refs": {'lobservatoiredespros', 'apuyeakgxjgdcfssrtek'},
}
